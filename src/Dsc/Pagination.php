...
class Pagination
{
    ...
    /*
     * EXAMPLE:: To make this work, Your routes need to map to your display functions when the page has the suffix, and a number in the route. $f3->route("GET|POST /{$base}/@resource/page/@page", "{$namespace}@resource->display"); $f3->route("GET|POST /{$base}/@resource/@action/page/@page", "{$namespace}@resource->@action"); if you want you can over ride the routeKeyPrefix in your config files, PAGINATION_KEY=split/ PAGINATION_KEY=somethingelse/
     */
